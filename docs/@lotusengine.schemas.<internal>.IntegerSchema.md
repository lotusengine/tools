...
[@lotusengine/schemas](../wiki/@lotusengine.schemas).[<internal>](../wiki/@lotusengine.schemas.%3Cinternal%3E).IntegerSchema

## Hierarchy

- [`BaseSchema`](../wiki/@lotusengine.schemas.%3Cinternal%3E.BaseSchema)<[`IntegerSchema`](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema)\>
...
- [isFluentJSONSchema](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#isfluentjsonschema)
- [isFluentSchema](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#isfluentschema)

### Methods

- [allOf](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#allof)
- [anyOf](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#anyof)
- [const](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#const)
- [default](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#default)
- [description](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#description)
- [enum](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#enum)
- [examples](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#examples)
- [exclusiveMaximum](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#exclusivemaximum)
- [exclusiveMinimum](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#exclusiveminimum)
- [id](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#id)
- [ifThen](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#ifthen)
- [ifThenElse](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#ifthenelse)
- [maximum](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#maximum)
- [minimum](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#minimum)
- [multipleOf](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#multipleof)
- [not](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#not)
- [oneOf](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#oneof)
- [raw](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#raw)
- [readOnly](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#readonly)
- [ref](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#ref)
- [required](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#required)
- [title](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#title)
- [writeOnly](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema#writeonly)
...
▸ **exclusiveMaximum**(`max`): [`IntegerSchema`](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema)
...
▸ **exclusiveMinimum**(`min`): [`IntegerSchema`](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema)
...
▸ **maximum**(`max`): [`IntegerSchema`](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema)
...
▸ **minimum**(`min`): [`IntegerSchema`](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema)
...
▸ **multipleOf**(`multiple`): [`IntegerSchema`](../wiki/@lotusengine.schemas.%3Cinternal%3E.IntegerSchema)
